...
export const tempMailList: TempMail[] = [
  { id: '1', name: 'YOPmail', url: 'https://yopmail.com/', description: '无需注册,即时可用' },
  ...
  { id: '5', name: 'Mohmal', url: 'https://www.mohmal.com/', description: '支持阿拉伯语' },
  { id: '6', name: 'Mailinator', url: 'https://www.mailinator.com/', description: '公共收件箱' },
  { id: '7', name: 'ThrowAwayMail', url: 'https://www.throwawaymail.com/', description: '随机生成邮箱' },
  { id: '8', name: 'Fake Mail Generator', url: 'https://www.fakemailgenerator.com/', description: '批量生成' },
  { id: '9', name: 'TempMail.plus', url: 'https://tempmail.plus/', description: '现代化界面' },
  { id: '10', name: 'Maildrop', url: 'https://maildrop.cc/', description: '无需注册' },
];
